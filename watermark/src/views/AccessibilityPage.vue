      ...
      <div class="fr-container">
        <div class="fr-grid-row justify-content-center">
          <div class="fr-col-md-10 fr-col-lg-8">
            ...
            <p>
              FiligraneFacile s’engage à rendre ses sites internet, intranet,
            ...
            <p>
              ...
              suivantes :
              <a
                href="https://www.numerique.gouv.fr/uploads/DINUM_SchemaPluriannuel_2020.pdf"
            ...
            <p>
              <strong>FiligraneFacile</strong> est <strong>non conforme</strong> avec le

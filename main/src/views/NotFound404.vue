...
export default {
  data() {
    return {
      ovoidSprite: require("@gouvfr/dsfr/dist/artwork/background/ovoid.svg"),
      technicalErrorSprite: require("@gouvfr/dsfr/dist/artwork/pictograms/system/technical-error.svg"),
    };
  }
};
</script>

                ...
                <AccordionElement id="rf-accordion-group-0-body-1">
                  <template v-slot:header>
                    <header>
                      ...
                      DossierFacile pour recevoir des dossiers DossierFacile ?
                    </header>
                  </template>
                  <template v-slot:body>
                    <p>
            ...
            >
              <li class="rf-accordion-group__item">
                <accordion-element id="rf-accordion-group-1-body-0">
                  ...
                  <template v-slot:body>
                    ...
                    mail renseignée est bien correcte et n'a pas déjà été
                    utilisée pour créer un compte.<br />3) Vérifiez vos emails :
                    peut-être avez-vous déjà reçu un mail de DossierFacile vous
                    confirmant la création de votre compte !<br />4)
                    Contactez-nous à contact@dossierfacile.fr et décrivez-nous
                    votre situation. Nous vous répondrons dans les meilleurs
                    délais.
                  </template>
                </accordion-element>
              </li>
              <li class="rf-accordion-group__item">
                <accordion-element id="rf-accordion-group-1-body-1">
                  ...
                  <template v-slot:body>
                    ...
                    <p>
                      Si vous n’avez rien modifié c’est sûrement que les
                      documents fournis sont maintenant « dépassés » : par
                      exemple, si nous venons de changer de mois il faut que
                      vous ajoutiez vos documents du mois qui vient de
                      s’écouler.
                    </p>
                  </template>
                </accordion-element>
              ...
              <li class="rf-accordion-group__item">
                <accordion-element id="rf-accordion-group-1-body-2">
                  ...
                  <template v-slot:body>
                    1) Si vous êtes en colocation c’est sûrement que le dossier
                    de votre colocataire n’a pas encore été validé.<br />2) Si
                    vous n’êtes pas en colocation contactez-nous à l’adresse
              ...
              <li class="rf-accordion-group__item">
                <accordion-element id="rf-accordion-group-2-body-2">
                  ...
                  <template v-slot:body>
                    ...
                    de la création de votre compte. Attention aux fautes de
                    frappe !
                  </template>
                </accordion-element>
              </li>
                ...
                <accordion-element id="rf-accordion-group-3-body-0">
                  ...
                  <template v-slot:body>
                    ...
                    <p>
                      ...
                      Seules nos équipes techniques peuvent y accéder.
                    </p>
                    <p>
                ...
                <accordion-element id="rf-accordion-group-3-body-2">
                  ...
                  <template v-slot:body>
                    <p>
                      ...
                      l'impact et la diffusion territoriale de DossierFacile et
                      en analysant les usages (notamment pour déterminer les
                      options les plus pertinentes à vous proposer en fonction
                ...
                <accordion-element id="rf-accordion-group-3-body-3">
                  ...
                  <template v-slot:body>
                    ...
                    <p>
                      ...
                      éléments peuvent nous permettre de retrouver votre
                      compte).
                    </p>
                  </template>
                </accordion-element>

        ...
        <div class="fr-col-md-10 fr-col-lg-8">
          <article>
            <div class="text-center fr-mt-3w fr-mb-3w">
              ...
              <p>12 Décembre 2019 dans <a href="#">DossierFacile</a></p>
            </div>
            <!--end article title-->
            <div>
              <p>
              ...
              <p>
                ...
                <b>
                  Présenter un dossier cohérent et complet de manière claire
                </b>
                relève aujourd’hui de l’exploit et peut prendre des heures si
                l’on s’y prend mal ou que l’on n’est pas un professionnel de
                l’informatique. Avec DossierFacile, si vous avez déjà tous vos
              ...
              <p>
                D’une part, grâce à la clarté, la complétude et la cohérence de
                votre dossier que garantit le label DossierFacile,<b>
                  vous gagnez 24% de chances que le propriétaire de
                  l’appartement que vous désirez vous réponde.</b
                >
              </p>
              <p>
              ...
              <p>
                ...
                et un mot de passe pour protéger l’accès à vos documents.
              </p>
              <p>
                Ensuite, après avoir choisi si vous louez seul, en colocation ou
              ...
              <ul>
                ...
                <li>
                  ...
                  de taxes foncières (propriétaires) ou une attestation
                  d’hébergement à titre gratuit
                </li>
              ...
              <p>
                ...
                si tout est bon, nous validons votre dossier. Vous recevez alors
                un lien vers votre
                <b>dossier « 3C » (Complet, Clair et Cohérent) </b>que vous
                pouvez dès lors envoyer à votre futur propriétaire.
              </p>
            </div>
          </article>
          <!--end item-->

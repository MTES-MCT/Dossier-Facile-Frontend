        ...
        <div class="fr-col-md-10 fr-col-lg-8">
          <article>
            ...
            <div>
              ...
              <p></p>
              <h2>
                Au secours ! Je suis locataire et mon ascenseur est en panne,
                que faire ?
              </h2>
              <p>
              ...
              <p>
                Petit rappel : la vie en copropriété réunit plusieurs types
                d'intervenants : les occupants, propriétaires ou locataires, le
                conseil syndical, composé de copropriétaires et le syndic,
                chargé d'assurer la bonne gestion de l'ensemble.
              </p>
              <p>
                C’est le syndic qui gère l’immeuble et ses équipements, par
                exemple l’ascenseur s’il y en a un. Ce syndic est une entreprise
                privée en contrat avec tous les propriétaires de l’immeuble et
                qui fonctionne grâce au paiement par ces derniers de charges de
                copropriété.
              </p>
              <p>
              ...
              <p>
                ...
                en l’absence de réponse, par lettre recommandée avec demande
                d’avis de réception avec mise en demeure de faire le nécessaire
                auprès du syndic de copropriété pour la réparation de
              ...
              <p>
                ...
                >
                qui prévoit que, dans le cadre d’un bail d’habitation de
                résidence principale, le propriétaire bailleur a l’obligation :
              </p>
              <ul>
                <li>
                  de délivrer un logement en bon état d'usage et de réparation
                  ainsi que les équipements mentionnés au contrat de location en
                  bon état de fonctionnement.
                </li>
                <li>d’assurer une jouissance paisible du logement</li>
                <li>
                  d’entretenir les locaux et y faire toutes les réparations,
                  autres que locatives, nécessaires au maintien en état et à
              ...
              <h2>
                Le syndic peut agir en lieu et place du propriétaire à l’égard
                d’un locataire
              </h2>
              <p>
                Attention, le règlement de copropriété s’applique aussi aux
                locataires ! Un propriétaire doit veiller à ce que ses
                locataires respectent ce règlement. Mais la loi prévoit
                cependant que le syndic, sous certaines conditions, notamment
                l'autorisation de l'assemblée générale des copropriétaires,
                puisse agir en lieu et place du propriétaire si ce dernier ne
                prend pas ses responsabilités à l'égard de son locataire.
              </p>
              <h2>Nouveau !</h2>
              <p>
                ...
                circulaire), le syndic aura l'obligation d'informer les
                occupants et les copropriétaires sur les règles locales
                applicables en matière de tri sélectif des ordures ménagères et
                des modalités d'accès aux déchetteries dont dépend la
                copropriété.
              </p>
            </div>
          </article>

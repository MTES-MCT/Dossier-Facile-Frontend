        ...
        <div class="fr-col-md-10 fr-col-lg-8">
          <article>
            <div class="text-center fr-mt-3w fr-mb-3w">
              <h1 class="fr-h1">
                <i>Dossier</i>Facile : un service numérique de l’État sans
                .gouv.fr ?
              </h1>
              <p>14 Mars 2023 dans <a href="#">DossierFacile</a></p>
            </div>
            <div>
              <p>
              ...
              <p>
                ...
                ou un ministère en particulier. Initialement, le choix d'un nom
              ...
              <p>
                Néanmoins, DossierFacile est un site sur lequel les utilisateurs
                partagent de nombreuses données personnelles, et beaucoup
                d’entre eux nous ont fait remarquer qu’il ferait davantage
                confiance à un site en .gouv.fr. D’autres témoignages ont montré
                que certains pensaient carrément que nous étions une arnaque.
                ...
                et celui de l’<a
                  ...
                  >Observatoire Numérique de la qualité des démarches en
                  ligne</a
                >.
              </p>
              <p>
                Pour régler ce problème, nous avons donc décidé d’adopter le
                fameux .gouv !
              </p>
              <p>
                Le .gouv devrait en outre permettre à DossierFacile de mieux se
                positionner sur les moteurs de recherche, en améliorant son
                référencement naturel, pour attirer un maximum d'utilisateurs.
              </p>
              <p>
                Le .gouv.fr est ce qu’on appelle un TLD ou “top-level domain”
                (en français : domaine de premier niveau) que l’on ajoute aux
                URL des sites du gouvernement afin de les reconnaître plus
                facilement. Cela permet aussi aux utilisateurs des services
                numériques d'être sûr qu’il s’agisse bien d’un site internet
                étatique. Le .gouv.fr a donc pour but de rassurer les
              ...
              <p>
                Un très grand nombre de conditions doivent être remplies pour
                obtenir le .gouv : respect de nombreux référentiels et
                réglementations sur le protection des données, la sécurité,
                l’accessibilité numérique pour les personnes en situation de
              ...
              <p>
                Après plusieurs mois d’efforts, DossierFacile remplit quasiment
                toutes les conditions requises pour l’obtention du précieux
                sésame. Nous finalisons notre conformité sur l’accessibilité
                numérique pour atteindre les 75% d’accessibilité requis.
              </p>
              <p>

...
<i18n>
{
  "en": {
    ...
    "contract-page": "the page of your contract indicating your future remuneration",
  ...
  "fr": {
    ...
    "contract-page": "la page de votre contrat qui indique votre rémunération à venir",

<template>
  ...
  <BackLinkRow label="Vous êtes salarié" @click="router.push(grandparent)" />
  <BackLinkRow label="Pas encore commencé ou depuis moins d’un mois" @click="router.push(parent)" />
  <p class="fr-mb-1w">

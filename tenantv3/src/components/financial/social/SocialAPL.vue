<template>
  ...
  <BackLinkRow label="Vous touchez l’aide personnalisée au logement (APL)" :to="parent" />
  <RadioList>
    ...
    <RadioListItem :to="here + '/pas-encore'">Vous ne touchez pas encore l’APL</RadioListItem>
  </RadioList>
  <FinancialFooter />
</template>

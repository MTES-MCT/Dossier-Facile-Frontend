<template>
  ...
  <BackLinkRow :label="t('rental-income.' + textKey)" :to="parent" />
  <RadioList>
    <RadioListItem :to="here + '/quittance'">{{ t('have-receipt.' + textKey) }}</RadioListItem>
    <RadioListItem :to="here + '/pas-de-quittance'">{{ t('no-receipt.' + textKey) }}</RadioListItem>
  </RadioList>
  <FinancialFooter />
</template>

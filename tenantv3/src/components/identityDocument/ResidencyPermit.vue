<template>
  <BackLinkRow :label="t('permit')" :to="parent" category="residency-permit" />
  <p class="fr-mb-0">{{ t('add-id-card') }}</p>
  <ul>
  ...
  <a
    ...
    >{{ t('permit-list') }}</a
  >
  <UploadFilesIdentity category="FRENCH_RESIDENCE_PERMIT" />
</template>
...
{
  "en": {
    "add-id-card": "Be sure to enclose your French or foreign identity card:",
    "valid": "valid",
    "both-sides": "both sides",
    "permit-list": "List of residence permits"
  },
  "fr": {
    "add-id-card": "Assurez-vous de joindre votre carte d’identité française ou étrangère :",

<template>
  ...
  <i18n-t keypath="please-provide" tag="p">
    <strong>{{ t(textKey + '.company-proof') }}</strong>
  </i18n-t>
...
<i18n>
{
  "en": {
    ...
    "couple": {
      "company-proof": "a certificate from their guarantor's employer"
    }
  },
  "fr": {
    ...
    "couple": {
      "company-proof": "une attestation de l'employeur de son garant"
    }
  }
}
</i18n>

<template>
  <SpouseGuarantorIdentificationProvider v-if="guarantor?.typeGuarantor === 'NATURAL_PERSON'" />
...
import SpouseGuarantorIdentificationProvider from './SpouseGuarantorIdentificationProvider.vue'

...
app.use(function(req, res, next) {
  res.setHeader(
    ...
    "default-src 'self'; " +
      "script-src 'self' *.dossierfacile.fr *.dossierfacile.fr:* https://www.google-analytics.com https://www.googletagmanager.com https://stats.data.gouv.fr https://www.google.com https://www.gstatic.com https://beacon-v2.helpscout.net 'unsafe-inline' 'unsafe-eval' blob:; " +
      ...
      "img-src 'self' https://www.google-analytics.com https://fonts.gstatic.com https://voxusagers.numerique.gouv.fr *.helpscout.net *.cloudfront.net *.gitbook.com data:; " +
      ...
      "object-src 'none'; " +
      "connect-src https://sentry.incubateur.net https://www.google-analytics.com https://stats.data.gouv.fr *.dossierfacile.fr:* https://stats.g.doubleclick.net https://sso-preprod.dossierfacile.fr *.cloudfront.net *.dossierfacile.fr 'unsafe-eval' *.helpscout.net wss://ws-helpscout.pusher.com https://sockjs-helpscout.pusher.com blob:; " +

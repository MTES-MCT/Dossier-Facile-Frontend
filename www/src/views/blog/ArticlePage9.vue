  ...
  >
    ...
    <p>
      ...
      <a
        ...
        >simulateur</a
      >
      a d’ailleurs été mis en place par l’État pour vous permettre de savoir si votre logement est
    ...
    <p>
      ...
      <a
        ...
        >réviser le loyer</a
      >
      1 fois par an à la condition qu'une clause inscrite dans le bail le prévoit.
    </p>
    <h2>Le versement du loyer</h2>
    <p>
      Le loyer et les charges sont à payer pendant toute la durée du bail à la date convenue et
      indiquée dans ce dernier.
    </p>
    <p>
    ...
    <p>
      ...
      >, sauf si le locataire n'est pas en cause (exemple : non versement des aides au logement en
      cas de
      <a
    ...
    <p>
      À savoir : aucun frais ne peut être facturé par le propriétaire en cas de retard de paiement
      du loyer. La mise en place d’une clause dans le contrat de location, autorisant le
    ...
    <p>
      A noter également, le dépôt de garantie versé par le locataire en début de location ne lui
      permet pas de
      <a
    ...
    <p>
      Différents moyens de paiement peuvent être proposés au locataire qui est libre de refuser la
    ...
    <ul>
      ...
      <li>Chèque ;</li>
      <li>Espèces, à la condition que le montant à payer soit inférieur à 1 000 €</li>
    </ul>
    ...
    <p>
      ...
      >, document qui atteste que le locataire a payé intégralement le loyer et les charges et ce de
      façon totalement gratuite. La quittance doit indiquer le détail des sommes versées par le
      ...
      <a
        ...
        >charges</a
      >.<br />
      Elle est le plus souvent mensuelle mais il n’y a pas de règles spécifiques sur la période
      qu’elle couvre.
    </p>
    <p>
      A savoir : en cas de paiement partiel du loyer, le propriétaire ou l'agence immobilière doit
      remettre au locataire un reçu.
    </p>
    <h2>Difficultés à payer votre loyer ?</h2>
    <p>
      Si vous rencontrez des difficultés pour payer votre loyer (mais sans impayés), sachez que des

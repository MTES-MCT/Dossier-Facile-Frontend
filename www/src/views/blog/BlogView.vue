...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: "Venez découvrir nos articles de blog pour vous éclairer sur les points d’éventuelle difficulté que vous rencontrez en créant votre dossier de location",
    },
  ],
})

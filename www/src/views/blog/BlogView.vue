<template>
  <section class="blog">
    <h1>{{ t('blog-title') }}</h1>
    <ul role="list">
      <li v-for="(item, idx) in articles" :key="idx" class="fr-mb-3w">
        <DsfrCard
          title-tag="h2"
          :title="item.title"
...
const articles = [
  ...
  },
  {
    ...
    link: '/blog/etudiant-etranger-logement',
    image: article24Img,
    date: '12 mai 2025'
  },
  {
    ...
    link: '/blog/eviter-les-arnaques-location',
    image: article13Img,
    date: '10 avril 2025'
  },
  {
    ...
    link: '/blog/documents-auto-entrepreneur',
    image: article19Img,
  ...
  },
  {
    ...
    link: '/blog/guide-etape-par-etape-pour-trouver-appartement-ideal',
    image: article24Img,
  ...
  },
  {
    ...
    link: '/blog/proprietaire-comment-detecter-fausse-fiche-paie',
    image: article23Img,
    date: '19 Avril 2024'
  },
  {
    ...
    link: '/blog/dossierfacile-devient-dossierfacile-logement-gouv-fr',
    image: article22Img,
  ...
  },
  {
    ...
    link: '/blog/guide-aide-etudiant-logement',
    image: article21Img,
  ...
  },
  {
    ...
    link: '/blog/dossierfacile-lance-filigrane-facile',
    image: article20Img,
    date: '10 Août 2023'
  },
  {
    ...
    link: '/blog/tout-ce-que-vous-devez-savoir-avant-de-quitter-votre-logement',
    image: article19Img,
    date: '31 Mai 2023'
  },
  {
    ...
    link: '/blog/un-garant-qui-comment-pourquoi',
    image: article18Img,
    date: '9 Mai 2023'
  },
  {
    ...
    link: '/blog/que-verifier-lors-de-la-visite-d-un-logement',
    image: article17Img,
    date: '25 Avril 2023'
  },
  {
    ...
    link: '/blog/passoires-thermiques-top-depart-du-gel-des-loyers',
    image: article15Img,
    date: '5 janvier 2023'
  },
  {
    ...
    description:
      'Une « donnée personnelle » désigne « toute information se rapportant à une personne physique identifiée ou identifiable ». Par exemple : un nom et prénom, un identifiant (numéro client, numéro de téléphone...), une caractéristique (sexe, âge, revenu, état de santé...)',
    link: '/blog/engage-dans-la-protection-de-vos-donnees-personnelles',
    image: article14Img,
  ...
  },
  {
    ...
    link: '/blog/usurpation-d-identite-en-france-comment-prevenir-agir',
    image: article13Img,
    date: '1 Juin 2022'
  },
  {
    ...
    link: '/blog/au-secours-mon-ascenceur-est-en-panne',
    image: article12Img,
    date: '14 Avril 2022'
  },
  {
    ...
    link: '/blog/la-caution-locative-changement-en-vue-pour-2022',
    image: article11Img,
    date: '14 Mars 2022'
  },
  {
    ...
    link: '/blog/quand-les-journalistes-parlent-de-dossierfacile',
    image: article10Img,
  ...
  },
  {
    ...
    description:
      "Le montant du loyer d'un logement, qu'il soit loué vide ou meublé, est en principe fixé librement par le propriétaire. Toutefois, les communes situées en zone tendue sont soumises à l'encadrement des loyers. Dans ces villes, le loyer est plafonné lors de la mise en location du logement (cas d'un nouveau locataire) et lors du renouvellement du bail (cas du même locataire).",
    link: '/blog/loyer-locataire-ou-bailleur',
    image: article9Img,
  ...
  },
  {
    ...
    link: '/blog/comment-justifier-son-domicile',
    image: article8Img,
    date: '02 Juin 2021'
  },
  {
    ...
    description:
      "Devant la hausse des loyers, de nombreux locataires choisissent aujourd'hui de partager un logement afin de diviser le coût de la location. Pour le bailleur, la colocation permet de louer plus facilement un grand logement et de bénéficier d'une solidarité entre les locataires. Que ce soit entre amis, en famille ou bien avec des inconnus, la colocation obéit toutefois à de nombreuses règles que nous allons vous présenter.",
    link: '/blog/tout-comprendre-a-la-vie-en-colocation',
    image: article7Img,
    date: '03 Mai 2021'
  },
  {
    ...
    link: '/blog/dossierfacile-fait-peau-neuve',
    image: article6Img,
    date: '06 Avril 2021'
  },
  {
    ...
    link: '/blog/5-conseils-pour-trouver-l-appartement-de-ses-reves-en-region-parisienne',
    image: article5Img,
    date: '30 Mars 2021'
  },
  {
    ...
    link: '/blog/5-astuces-pour-booster-votre-dossier-de-location',
    image: article4Img,
    date: '25 Mars 2021'
  },
  {
    ...
    link: '/blog/pourquoi-dossierfacile-est-il-gratuit',
    image: article3Img,
  ...
  },
  {
    ...
    link: '/blog/constituer-votre-dossierFacile',
    image: article2Img,
  ...
  },
  {
    ...
    link: '/blog/quelles-pieces-justificatives-fournir-pour-mon-dossier-de-location',
    image: article1Img,
  ...
  },
  {
    ...
    description:
      "Votre dossier locatif numérique certifié par l'État, anciennement Locatio. Grâce à DossierFacile, ex-Locatio, vous pouvez monter facilement et gratuitement votre dossier de location en ligne.",
    link: '/blog/locatio-devient-dossier-facile',
    image: article0Img,
    date: '21 mars 2019'
  }
]

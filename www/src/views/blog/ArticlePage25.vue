<template>
  ...
  >
    ...
    <h3 class="fr-h4">a. Votre garant est une personne physique (ami.e / membre de la famille, etc...)</h3>
    <p>Il est demandé de fournir les mêmes pièces justificatives que pour votre dossier de location à savoir :</p>
    <ul>
    ...
    <p>
      <a href="https://www.visale.fr/" target="_blank" rel="noopener">Visale</a> est une caution entièrement gratuite d'<a href="https://www.actionlogement.fr/" target="_blank" rel="noopener">Action Logement</a>, qui a pour mission d'aider gratuitement les jeunes et les personnes les plus précaires à accéder à la location. Nous vous la recommandons fortement si vous êtes éligible !
    </p>
    <p>
    ...
    <p>
      Il est crucial de savoir quels documents il est interdit de demander. La vie privée du garant est protégée, et aucun justificatif lié à la situation personnelle, financière (relevé bancaire), de santé, ou antécédents judiciaires ne peut être exigé. Le service <a href="https://www.dossierfacile.fr/" target="_blank" rel="noopener">DossierFacile</a> vous demande uniquement les pièces obligatoires.
    </p>
    <p>
      En l'absence de garant, des alternatives existent, telles que la garantie Visale, les organismes garants en location, ou la Garantie Loyers Impayés (GLI), bien que cette dernière ne soit plus cumulable avec une caution depuis la <a href="https://www.legifrance.gouv.fr/loda/id/JORFTEXT000020438861/" target="_blank" rel="noopener">loi Boutin de 2009</a>.
    </p>
...
const title = 'Dossier de location : Comment choisir son garant et les documents à fournir pour votre dossier locatif'
const description = "Guide complet sur les documents à fournir pour votre garant dans un dossier de location. Découvrez les justificatifs nécessaires pour constituer un dossier locataire solide avec garant, que ce soit pour une personne physique, Visale ou une entreprise."
...
useHead({
  ...
  meta: [
    ...
    { name: 'keywords', content: 'garant, garant location, dossier location, dossier locataire, dossier locatif, dossier logement, caution location, documents garant' }
  ]
})
</script>

...
app.use(function(req, res, next) {
  res.setHeader(
    ...
    "default-src 'none'; " +
      ...
      "object-src 'none'; " +
      "prefetch-src 'self'; " +
      "connect-src https://www.google-analytics.com *.inspectlet.com wss://ws.inspectlet.com https://stats.g.doubleclick.net https://sso-preprod.dossierfacile.fr *.cloudfront.net *.dossierfacile.fr 'unsafe-eval' *.helpscout.net wss://ws-helpscout.pusher.com https://sockjs-helpscout.pusher.com http://localhost:8080 http://localhost:8085 https://dossierfacile-api-owner-preprod.osc-fr1.scalingo.io https://dossierfacile-front-staging-owner.osc-fr1.scalingo.io blob:; " +
      "frame-src https://www.google.com *.dossierfacile.fr http://localhost:8085; " +

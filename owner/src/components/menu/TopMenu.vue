...
<template>
  <nav class="top-edit-menu">
    ...
    <hr v-if="step === 1" />
    <div v-if="step === 1" ref="tcontainer" class="menu-grid-row">
      <div ref="td0" class="ml-5">

<template>
  <div class="fr-alert fr-alert--error">
    ...
    <a target="_blank" rel="noopener noreferrer" @click="AnalyticsService.dpeEvent('dpe_know_more')"
     href="https://www.service-public.fr/particuliers/vosdroits/F16096">{{  t('propertydiagnosticexpirywarning.know-more') }}</a>
    <a target="_blank" rel="noopener noreferrer"
     class="fr-btn fr-btn--secondary fr-ml-3w" @click="redirectFranceRenov" href="#">{{  t('propertydiagnosticexpirywarning.find-inspector') }}</a>
    </div>
  </div>
</template>

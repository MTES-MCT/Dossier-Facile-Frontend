...
<i18n>
{
  ...
  "fr": {
    ...
    "content-1": "Vous ne pouvez pas consulter les dossiers en cours de remplissage, en cours de traitement ou refusés. Vous ne pouvez consulter que les dossiers validés par notre équipe.",
